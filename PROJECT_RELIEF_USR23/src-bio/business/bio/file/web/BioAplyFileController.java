...
public class BioAplyFileController extends BaseController {
     ...
     * 신청서류그룹 목록 조회
     */
    @RequestMapping("/usr/file/getListBioPapeGroup.do")
    @ResponseBody
     ...
     */
    @RequestMapping("/usr/file/getListBioPape.do")
    @ResponseBody
     ...
     * comm_component.js 의 appBioAplyFile 에서 사용됨
     */
    @RequestMapping("/usr/file/getListBioAplyFileByPape.do")
    @ResponseBody
     ...
     * comm_component.js 의 appBioAplyFile 에서 사용됨
     */
    @RequestMapping("/usr/file/getListBioAplySubmitFile.do")
    @ResponseBody
    public Map getListBioAplySubmitFile(HttpServletRequest request
            , @RequestParam Map<String,String> reqMap
            , @ModelAttribute BioAplyFileVO aplyFileVO
        ...
        if (reqMap.containsKey("page")) {
        	...
        	list = aplyFileService.listBioAplySubmitFile(aplyFileVO, page, size);
        }
        else {
        	list = aplyFileService.listBioAplySubmitFile(aplyFileVO);
        }
     ...
     * comm_component.js 의 appBioAplyFile 에서 사용됨
     */
    @RequestMapping(value="/usr/file/downloadBioAplyFile.do")
     ...
     * comm_component.js 의 appBioAplyFile 에서 사용됨
     */
    @RequestMapping(value="/usr/file/downloadBioAplyFileZip.do")
    public void downloadBioAplyFileZip(HttpServletRequest request,
        ...
        // 다운로드할 파일 목록
        List<Map> list = aplyFileService.listBioAplySubmitFile(aplyFileVO);
     ...
     * comm_component.js 의 appBioAplyFile 에서 사용됨
     */
    @RequestMapping("/usr/file/downloadBioPapeFile.do")
     ...
     * comm_component.js 의 appBioAplyFile 에서 사용됨
     */
    @RequestMapping("/usr/file/uploadBioAplyFile.do")
    @ResponseBody
    public Map uploadBioAplyFile(HttpServletRequest request) throws Exception {
     ...
     * comm_component.js 의 appBioAplyFile 에서 사용됨
     */
    @RequestMapping(value="/usr/file/linkBioAplyFile.do")
    @ResponseBody
    public HttpEntity<byte[]> linkBioAplyFile(HttpServletRequest request,
    		HttpServletResponse response,
     ...
     * comm_component.js 의 appBioAplyFile 에서 사용됨
     */
    @RequestMapping(value = "/usr/file/linkBioAplyHwp{sn}.do", method= RequestMethod.GET)
     ...
     * comm_component.js 의 appBioAplyFile 에서 사용됨
     */
    @RequestMapping("/usr/file/getBioAplySubmitFile.do")
    @ResponseBody
    public Map getBioAplySubmitFile(HttpServletRequest request
            , @ModelAttribute BioAplyFileVO aplyFileVO
			, ModelMap model) throws Exception {
