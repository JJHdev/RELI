...
public class UsrAplyFileController extends BaseController {
     ...
     */
    @RequestMapping("/usr/file/getListAplyFileByPape.do")
    @ResponseBody
     ...
     * comm_component.js 의 appAplyFile 에서 사용됨
     */
    @RequestMapping("/usr/file/uploadAplyFile.do")
    @ResponseBody
     ...
     * comm_component.js 의 appAplyFile 에서 사용됨
     */
    @RequestMapping(value="/usr/file/downloadAplyFile.do")
     ...
     * comm_component.js 의 appAplyFile 에서 사용됨
     */
    @RequestMapping(value="/usr/file/downloadAplyFileZip.do")
     ...
     * comm_component.js 의 appAplyFile 에서 사용됨
     */
    @RequestMapping(value="/usr/file/linkAplyFile.do")
    @ResponseBody
    ...
    /**
     * 2021.10.15 LSH hwpjs 미리보기용 한글문서 URL링크보기
     * comm_component.js 의 appAplyFile 에서 사용됨
     */
    @RequestMapping(value = "/usr/file/linkAplyHwp{sn}.do", method= RequestMethod.GET)
     ...
     * comm_component.js 의 appAplyFile 에서 사용됨
     */
    @RequestMapping("/usr/file/getListAplySubmitFile.do")
    @ResponseBody
     ...
     * comm_component.js 의 appAplyFile 에서 사용됨
     */
    @RequestMapping("/usr/file/getAplySubmitFile.do")
    @ResponseBody
