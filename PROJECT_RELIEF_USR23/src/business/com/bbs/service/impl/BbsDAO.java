...
public class BbsDAO extends BaseDAO {
	 ...
	 * 메인화면 공지사항 팝업창
	 */
	public ArrayList<BbsVO> popupNotice(BbsVO bbsVO) {
		return (ArrayList<BbsVO>) list("Bbs.popupNotice", bbsVO);
	}
	/*
	 * 메인화면 공지사항 팝업창 상세조회
	 */
	public BbsVO viewPopupNotice(BbsVO bbsVO) {
		return (BbsVO)view("Bbs.viewPopupNotice", bbsVO);
	}
