        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    instanceName = (Math.round(window.crypto.getRandomValues(new Uint32Array(1))/4294967296 * 1000) + Date.now()).toString(16);
                ...
                case 5:
                    ...
                    Logger.getInstance(instanceName).debug("Finished rendering 2");
