...
<div class="viewWrap type1 formLayout">
	...
	<form:form commandName="form" id="registForm" name="registForm" method="post" enctype="multipart/form-data" onsubmit="return false;">
		...
		<div class="viewData1">
			<div>
				<b class="must">제목</b>
				<div><span><form:input path="nttSj" /></span></div>
			</div>
			<div>
				<b class="must">작성자</b>
			...
			<div>
		 	...
		 	<div class="cal">
				<b>게시기간</b>
				<div class="cal-date">
					<input id="pstgBgngYmd" name="pstgBgngYmd" class="easyui-datebox"> 
					<span style="padding: 0 5px;">~</span> 
					<input id="pstgEndYmd" name="pstgEndYmd" class="easyui-datebox"> 
				</div>
			</div> 
			<div>
				<b>팝업창 가로</b>
