...
*******************************************************************************
***	명칭: modalCmitMng.jsp
***	설명: 위원회 조사관리 - 위원등록 모달팝업
***
***	-----------------------------    Modified Log   ---------------------------
***	버전        수정일자        수정자        내용
*** ---------------------------------------------------------------------------
***	2.0      2023.01.12    LSH        First Coding.
*******************************************************************************
--%>
...
<script type="text/javascript" src="<c:url value='/js/adm/cmit/modalCmitMng.js'/>"></script>
			...
			<div class="boxInner type3">
				<table class="system-form w100">
					<tbody>
						...
						<tr>
							<td>피해지역</td>
							<td class="app-l"><select id="p_srchBizAreaCd" name="srchBizAreaCd" class="w100"></select></td>
						</tr>
						<tr>
							<td>임기차수</td>
