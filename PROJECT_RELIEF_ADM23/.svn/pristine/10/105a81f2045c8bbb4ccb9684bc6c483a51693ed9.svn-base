				...
				<div class="searchForm formLayout">
		            <form id="searchForm" name="searchForm" method="post" onsubmit="return false;">
						<div class="formGroup">
							...
							<div class="inputWrap">
			                    <select id="srchUpId" name="srchUpId" style="width:250px"></select>
							</div>
							<div class="inputWrap">
								<input  id="srchText" name="srchText" type="text" placeholder="메뉴ID,메뉴명,URL 등을 입력하세요." style="width:350px"/>
							</div>
						</div>
		            </form>
				</div>
		...
		<div class="listWrap div2 box">
			...
			<div class="tableGroup">
				<div class="subTit type2">
					<h4 class="app-left app-pt20">메뉴목록</h4>
					<div class="btnDiv">
					</div>
				</div>
			...
			<div class="formLayout">
				<div class="subTit type2">
					<h4 class="app-left app-pt20" id="registTitle">메뉴등록</h4>
					<div class="btnDiv">
	            ...
	            <form id="registForm" name="registForm" method="post" onsubmit="return false;">
					...
					<div class="formGroup col-md-12">
						<span class="col-md-2 must">상위메뉴</span>
						<div class="inputWrap col-md-10">
							<select id="upMenuId" name="upMenuId" class="w100"></select>
						</div>
					</div>
					<div class="formGroup col-md-12">
						<span class="col-md-2 must">메뉴ID</span>
						<div class="inputWrap col-md-10">
                            <input id="menuId" name="menuId" type="text" class="w100" maxlength="20" />
						</div>
					</div>
					<div class="formGroup col-md-12">
						<span class="col-md-2 must">메뉴명</span>
						<div class="inputWrap col-md-10">
							<input id="menuNm" name="menuNm" type="text" class="w100" maxlength="100"/>
						</div>
					</div>
					<div class="formGroup col-md-12">
						<span class="col-md-2">타겟URL</span>
						<div class="inputWrap col-md-10">
							<input id="trgtUrl" name="trgtUrl" type="text" class="w100" maxlength="100"/>
						</div>
					</div>
					<div class="formGroup col-md-12">
						<span class="col-md-2 must">메뉴레벨</span>
						<div class="inputWrap col-md-5">
							<input id="menuLvl" name="menuLvl" type="text" class="w100" maxlength="3"/>
						</div>
					</div>
					<div class="formGroup col-md-12">
						<span class="col-md-2">순　　서</span>
						<div class="inputWrap col-md-5">
							<input id="menuOrdr" name="menuOrdr" type="text" class="w100" maxlength="3"/>
						</div>
					</div>
					<div class="formGroup col-md-12">
						<span class="col-md-2">팝업여부</span>
						<div class="inputWrap col-md-5">
							<div id="appPopupYn"></div>
						</div>
					</div>
					<div class="formGroup col-md-12">
