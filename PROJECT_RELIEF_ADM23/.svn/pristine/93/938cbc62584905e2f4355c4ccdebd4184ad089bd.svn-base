	...
	<div class="boxInner">
		...
		<div class="searchForm formLayout">
			<form id="searchForm" name="searchForm" method="post" onsubmit="return false;">
				...
				<div class="formGroup" id="appCanCelTermBox"></div>
				<div class="formGroup">
					<p>신청자명</p>
					<div class="inputWrap">
						<div class="inputWrap">
...
<!-- 									<div id="appSprtSeCd"></div> -->
						...
						<li class="tabInnerFrom box">
							...
							<div class="formGroup col-md-6">
								<span class="label col-md-4">전자우편주소</span>
								<div class="inputWrap col-md-8">
									<input type="text" id="respdntEmlAddr" name="respdntEmlAddr" class="w100" value="mjmj@mjmjmj.com" />
								</div>
							</div>
							<div class="formGroup col-md-6">
								<span class="label col-md-4">
		...
		<div class="app-space25"></div>
		<div class="subTit type2">
			<h4 class="app-left app-pt">취소관리</h4>
			<div class="app-right btnDiv">
				<a href="#void" id="btnCancelHistory" class="btn blue">취소이력등록</a>
			</div>
			<div class="app-both"></div>
		</div>
		<div class="tableWrap type1 app-scroll" id="appCanCelTable" style="height: 100px;"></div>
		<!-- 이력관리 END // -->
	</div>
</div>
