...
<div class="statWrap">
	<div class="tabWrap type4">
		<ul class="li-3 box">
			<li data-mode="TOTAL"><a href="#">통합</a></li>
			<li data-mode="AREA"><a href="#">사업별</a></li>
		...
		<ul>
			<li class="tabInnerFrom" style="padding: 20px;">
				<div class="formLayout app-search-layout">
					<form id="searchTotalForm" name="searchTotalForm" method="post" onsubmit="return false;">
						<input name="mode" type="hidden"/>
						<div class="formGroup">
							<div class="inputWrap">
								<select id="srchStYearT" name="srchStYear" style="width:100px"></select>
								~
								<select id="srchEnYearT" name="srchEnYear" style="width:100px"></select>
							</div>
						</div>
					</form>
				</div>
				<div class="btnWrap type1">
	                <app:button id="btnTotalSearch" title="검색" cls="app-m3 blue" />
	                <app:button id="btnTotalExcel"  title="엑셀" cls="app-m3" />
				</div>
				...
				<div class="formLayout app-search-layout">
					<form id="searchAreaForm" name="searchAreaForm" method="post" onsubmit="return false;">
						...
						<div class="formGroup">
							...
							<p class="app-search-label">신청사업</p>
							<div class="inputWrap">
								<select id="srchBizOder" name="srchBizOder" style="width:150px"></select>
							</div>
							<p class="app-search-label">신청지역</p>
							<div class="inputWrap">
								<select id="srchBizArea" name="srchBizArea" style="width:150px"></select>
							</div>
							<p class="app-search-label">심의결과</p>
							<div class="inputWrap">
								<select id="srchRcognStus" name="srchRcognStus" style="width:150px"></select>
							</div>
						</div>
					</form>
				</div>
