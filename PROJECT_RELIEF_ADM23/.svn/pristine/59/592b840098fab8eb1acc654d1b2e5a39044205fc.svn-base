	...
	<form:form commandName="model" id="model1" name="model1" method="post"
		...
		<ul>
			<li class="tabInnerFrom on" style="padding: 50px;">
				...
				<div class="tableWrap type3 tableHeader">
						...
						<tbody>
							...
							<c:forEach var="row" items="${rows}" varStatus="st">
								<tr>
									...
									<td width=15%  ><span class="mobile"></span> <c:out value="${row.regYmd}" /></td>
									<td width=5% ><span class="mobile"></span> <c:out value="${row.popupYn}" /></td>
				...
				<div class="pagenation">
					...
					<a href=<c:url value="/adm/bbs/writeNotice.do"/>
						class="btn blue right">신규등록</a>
