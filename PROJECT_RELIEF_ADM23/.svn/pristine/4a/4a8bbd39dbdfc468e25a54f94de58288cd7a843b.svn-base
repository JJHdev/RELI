<%--
*******************************************************************************
***    명칭: listBrvfmRwrd.jsp
***    설명: 구제급여지급 - 유족보상비 화면
***
***    -----------------------------    Modified Log   ---------------------------
***    버전        수정일자        수정자        내용
*** ---------------------------------------------------------------------------
***    1.0      2023.01.05    LSH        First Coding.
*******************************************************************************
--%>
...
<div class="listWrap div2 box">
	...
	<div class="formLayout">
		...
		<form id="registForm" name="registForm" method="post" onsubmit="return false;" >
			...
			<input type="hidden" name="brvfmRwrdAmt"    />
			
			<div class="boxInner type3">
				<div class="formGroup col-md-12">
					<span class="label col-md-3">피해등급</span>
					<div class="inputWrap col-md-4">
						<input type="text" id="lastDmgeGrdCd" name="lastDmgeGrdCd" class="w100" />
					</div>
				</div>
				<div class="formGroup col-md-12">
					<span class="label col-md-12">구제급여 집계</span>
					<div class="inputWrap col-md-12">
						<div id="appRegistTable"></div>
					</div>
				</div>
				<div class="formGroup col-md-12">
					<span class="label col-md-3">유족보상비 잔액</span>
					<div class="inputWrap col-md-4">
						<input type="text" id="brvfmRwrdAmtKor" name="brvfmRwrdAmtKor" class="w100 app-readonly" readonly />
					</div>
				</div>
				<div class="formGroup col-md-12">
					<span class="label col-md-3">유족보상비 지급일자</span>
					<div class="inputWrap col-md-4">
						<input type="text" id="brvfmRwmnyGiveYmd" name="brvfmRwmnyGiveYmd" maxlength="10" class="easyui-datebox" style="width:100%"/>
					</div>
				</div>
			</div>
			<div class="app-space10"></div>
