...
public class McpDtlsServiceImpl extends BaseService implements McpDtlsService {
	...
	public int loadMcpDtls(McpDtlsVO mcpDtlsVO, FileInfo fileInfo) throws Exception {
    	...
    	if (dataList == null)
    	    ...
    	    // 기 등록된 데이터 전체 삭제 [2022.03.17 ntarget]
    	    mcpDtlsDAO.deltMcpDtlsAll(mcpDtlsVO);
    	}
    	...
    	// 인정금액 업데이트
    	updtMcpDtlsAmt(mcpDtlsVO);
    	
    	return ret;
	}
	
    /**
     * 인정금액 업데이트 [2022.03.17 ntarget]
     */
    private int updtMcpDtlsAmt(McpDtlsVO mcpDtlsVO) throws Exception {
        MnsvyVO mnsvyVO = new MnsvyVO();
        BeanUtils.copyProperties(mcpDtlsVO, mnsvyVO);
        
        return mnsvyDAO.updtMcpDtlsAmt(mnsvyVO);
    }
    ...
    public McpDtlsVO viewMcpSckwnd(McpDtlsVO mcpDtlsVO) throws Exception {
    	return mcpDtlsDAO.viewMcpSckwnd(mcpDtlsVO);
    }
    ...
    public long viewMcpDtlsTotalBySearch(McpDtlsVO mcpDtlsVO) throws Exception {
    	return mcpDtlsDAO.viewMcpDtlsTotalBySearch(mcpDtlsVO);
    }
    ...
    public long viewMcpDtlsTotalByAply(McpDtlsVO mcpDtlsVO) throws Exception {
    	return mcpDtlsDAO.viewMcpDtlsTotalByAply(mcpDtlsVO);
    }
}