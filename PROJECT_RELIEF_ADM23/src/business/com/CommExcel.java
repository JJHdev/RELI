...
public enum CommExcel {
	...
	ABSTRCT ("초본주소 등록", 0, 1, 1, 0, true, 
			new String[] {
				"idntfcId" , "abstrctAddr" , "dclrYr" , "dclrResn" , "gapDstnc" ,
				"lat"      , "lot"
			},
			new String[] {
				"식별ID" , "주소" , "신고년도" , "신고사유" , "이격거리(km)" ,
				"위도"   , "경도"
			},
			new boolean[] {	
	...
	RCPERLVLH ("요양생활수당 지급일자 일괄등록", 0, 1, 1, 0, true, 
			new String[]  {"idntfcId"     , "exmnOder"    , "giveYm"      , "giveYmd"},
			new String[]  {"식별ID"       , "본조사차수"  , "지급년월"    , "지급일자"},
