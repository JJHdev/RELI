...
public class ReliefVO extends BaseModel {
	...
	// 조사결과(다중선택) 2022.03.02 ntarget 추가
    private List<String> dltncRsltExmnList;
    ...
    // 2022.12.07 서류코드 (관리자 제출서류 추가등록시 필요)
    private String papeCd;
    // 2022.12.07 상위서류코드 (관리자 제출서류 추가등록시 필요)
    private String upPapeCd;
    
    // 2022.12.16 사망일자
    private String dthYmd;
    
    // 2022.12.16 예비조사 사업차수
    private String prptBizOder;
    
    // 2022.12.16 예비조사 조사차수
    private String prptExmnOder;
