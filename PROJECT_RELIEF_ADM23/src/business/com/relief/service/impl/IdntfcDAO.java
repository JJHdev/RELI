...
public class IdntfcDAO extends BaseDAO {
     ...
     * 피해자정보 상세 조회
     */
    public IdntfcVO viewIdntfc(String sufrerNo) {
        return (IdntfcVO)view("Idntfc.viewIdntfc", sufrerNo);
    }
     ...
     */
    public IdntfcVO viewIdntfcById(IdntfcVO idntfcVO) {
        return (IdntfcVO)view("Idntfc.viewIdntfcById", idntfcVO);
    }
     ...
     * 피해자의 피해지역 거주기간 업데이트
	 * @param  (필수) idntfcVO.idntfcId   : 식별아이디
	 * @param  (필수) idntfcVO.gsUserNo   : 세션사용자번호
     */
    public int updtIdntfcResiWhlCn(IdntfcVO idntfcVO) {
        return update("Idntfc.updtIdntfcResiWhlCn", idntfcVO);
    }
}