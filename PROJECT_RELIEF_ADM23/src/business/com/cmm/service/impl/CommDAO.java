...
public class CommDAO extends BaseDAO {
     ...
     */
    public List getListPapeCode(Map paramMap) {
        return list("Comm.getListPapeCode", paramMap);
    }
     ...
     * 공휴일 연도 Combo목록 조회
     */
    public List getComboHdlyYear(Map paramMap) {
    	return list("Comm.getHldyYear", paramMap);
    }
