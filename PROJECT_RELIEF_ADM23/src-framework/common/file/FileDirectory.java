...
public enum FileDirectory {
	...
	, BOARD          ( "/board"       , "BOARD"        , null           , "게시판경로")
	, SIGNATURE      ( "/signature"   , "SIGN"         , null           , "전자서명파일경로")
	, PAPER          ( "/paper"       , "PAPE"         , null           , "신청파일경로")
	, PRPTEXMN       ( "/prptexmn"    , "PEXMN"        , "EXMN01"       , "예비조사서류경로")
	, MNSVY          ( "/mnsvy"       , "MNSVY"        , "EXMN02"       , "본조사서류경로")
	, FORMFILE       ( "/formfile"    , "FORMFILE"     , null           , "양식파일경로")
	, SMSFILE        ( "/smsfile"     , "SMSFILE"      , null           , "SMS전송파일경로")
	, DECRYPT        ( "/decrypt"     , "DECRYPT"      , null           , "복호화파일저장경로")
	, CKIMAGE        ( "ckimage"      , "CKIMAGE"      , null           , "CKEDITOR이미지경로")
	, OCR            ( "/ocr"         , "OCR"          , null           , "OCR결과저장경로")
	, BIOPAPER       ( "/bio/paper"   , "BIOPAPE"      , null           , "살생물제품 신청파일경로") // 2023.01.17 추가
	, BIOSIGN        ( "/bio/signature","BIOSIGN"      , null           , "살생물제품 전자서명파일경로") // 2023.01.17 추가
	;
