...
***	버전        수정일자        수정자        내용
*** ---------------------------------------------------------------------------
***	1.0      2021.11.22    LSH        First Coding.
*******************************************************************************
--%>
	...
	<div class="app-view">
		<div>
			...
			<div style="width:100px">
				<input type="radio" id="srchAddYnY" name="srchAddYn" value="Y"> <label for="srchAddYnY">Y</label>
				<input type="radio" id="srchAddYnN" name="srchAddYn" value="N"> <label for="srchAddYnN">N</label>
			</div>
		</div>
		<div>
			<b>식별ID</b>
		...
		<div>
			<b>피해지역</b>
			<div style="width:120px"><span id="s_bizAreaNm"><c:out value="${form.bizAreaNm}"/></span></div>
			<b>사업차수</b>
			<div style="width:120px"><span id="s_bizOderNm"><c:out value="${form.bizOderNm}"/></span></div>
			<b>본조사차수</b>
			<div style="width:120px"><span id="s_exmnOder"><c:out value="${form.exmnOder}"/></span></div>
		</div>
	</div>
