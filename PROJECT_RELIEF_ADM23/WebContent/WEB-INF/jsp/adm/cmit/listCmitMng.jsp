...
***    버전        수정일자        수정자        내용
*** ---------------------------------------------------------------------------
***    1.0      2023.01.09    LSH        First Coding.
*******************************************************************************
--%>
		...
		<div class="searchConditions-wrap boxInner">
			...
			<div class="searchForm formLayout">
				...
				<div class="formGroup">
					...
					<div class="inputWrap">
						<div class="inputWrap">
							<select id="srchBizAreaCd" name="srchBizAreaCd" style="width:210px"></select>
						</div>
						<div class="inputWrap">
							<span>위원회 차수</span>
						...
						<div class="boxInner type2 box">
							<form id="cmitForm" name="cmitForm" method="post" onsubmit="return false;" >
								...
								<div class="formGroup col-md-12">
									...
									<div class="inputWrap col-md-10">
										<select id="bizAreaCd" name="bizAreaCd" class="w100"></select>
									</div>
								</div>
								<div class="formGroup col-md-12">
