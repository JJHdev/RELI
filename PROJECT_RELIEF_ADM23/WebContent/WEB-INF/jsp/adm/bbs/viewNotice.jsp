...
<div class="tabWrap type4">
	<ul class="li-2 box">
		<li class="on"><a href="#void">공지사항</a></li>
	</ul>
</div>
			...
			<li class="tabInnerFrom on" style="padding: 50px;">
				<div class="viewWrap type1">
					...
					<div class="viewData">
						...
						<div>
							<b>팝업여부</b>
							<div><span><c:out value="${model.popupYn}" /></span></div>
						</div>
						<div>
							<b>게시기간</b>
							<div><span><c:out value="${model.pstgBgngYmd}" /></span>
							<span style="padding: 5px;">~</span>
							<span><c:out value="${model.pstgEndYmd}" /></span></div>
						</div>
						<div>
							<b>팝업너비</b>
							<div><span><c:out value="${model.popupSqr}" /></span></div>
							<b>팝업높이</b>
							<div></span><c:out value="${model.popupHght}" /></span></div>
						</div>
						<div>
							<b>첨부파일</b>
