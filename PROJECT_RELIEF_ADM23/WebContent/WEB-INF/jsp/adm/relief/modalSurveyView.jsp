...
***	버전        수정일자        수정자        내용
*** ---------------------------------------------------------------------------
***	1.0      2022.01.05    LSH        First Coding.
*******************************************************************************
--%>
...
<script type="text/javascript" src="<c:url value='/js/adm/relief/modalSurveyView.js'/>"></script>
...
<form:hidden id="p_rgtrNm"     path="rgtrNm"     />
<form:hidden id="p_regDate"    path="regDate"    />
...
<div class="layerWrap">
	...
	<div class="layerPop-inner relief ">
				...
				<p class="right app-sign-area">
					...
					<c:if test="${!empty form.signCn}">
						<span class="app-sign-file">
							<img src="<c:url value='/adm/relief/linkSurveySign.do?rspnsMngNo='/>${form.rspnsMngNo}" width="150"/>
						</span>
					</c:if>
				</p>
			</div>
		...
		<div class="btnWrap type3">
			...
			<a href="javascript:void(0);" id="btnSurveyPrint">공문양식으로 프린트</a>
		</div>
	</div>
</div>
